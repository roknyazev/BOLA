...
public:
    ...
    void navigation() {
        ...
        ARINC_BNR pack_1;
        pack_1.bits.adress = 62;        // Формирование 1-го слова
...
public:
    ...
    void navigation() {
        ...
        ARINC_BNR pack_1;
        pack_1.bits.adress = 200; // Формирование 1-го слова
        ...
        ARINC_BNR pack_2;
        pack_2.bits.adress = 201; // Формирование 2-го слова
        ...
        ARINC_BNR pack_3;
        pack_3.bits.adress = 241; // Формирование 3-го слова
        ...
        ARINC_BNR pack_4;
        pack_4.bits.adress = 204; // Формирование 4-го слова
        ...
        ARINC_BNR pack_5;
        pack_5.bits.adress = 212; // Формирование 5-го слова
        ...
        ARINC_BNR pack_6;
        pack_6.bits.adress = 213; // Формирование 6-го слова
        ...
        ARINC_BNR pack_7;
        pack_7.bits.adress = 246; // Формирование 7-го слова
        ...
        ARINC_BNR pack_8;
        pack_8.bits.adress = 247; // Формирование 8-го слова
        ...
        ARINC_BNR pack_9;
        pack_9.bits.adress = 245; // Формирование 9-го слова
        ...
        ARINC_BNR pack_10;
        pack_10.bits.adress = 217; // Формирование 10-го слова
        ...
        ARINC_BNR pack_11;
        pack_11.bits.adress = 218; // Формирование 11-го слова
        ...
        ARINC_BNR pack_12;
        pack_12.bits.adress = 219; // Формирование 12-го слова
        ...
        ARINC_DISCRETE pack_13; 
        pack_13.bits.adress = 184; //
        pack_13.bits.SDI = 1; //
